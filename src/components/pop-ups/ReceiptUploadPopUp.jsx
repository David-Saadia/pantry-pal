...
export default function ReceiptUploadPopUp({isOpen, onClose, onScanComplete}) {
        ...
        reader.onloadend = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    onScanComplete(data["ingredients"]);
                }
            } catch (e) {
        ...
        >
            ...
            >
                ...
                <div className="mt-6 text-center">
                    {isLoading ? (
                        <div
                            className="border-2 border-dashed border-emerald-green/30 bg-emerald-green/5 dark:border-emerald-green/50 dark:bg-emerald-green/10 rounded-lg p-8 lg:p-12 flex flex-col items-center justify-center">
                            <svg className="animate-spin h-12 w-12 text-emerald-green" fill="none" viewBox="0 0 24 24"
